...
function publicMessage(code) {
  const messages = {
    ...
    SIGNUP_DISABLED: "Public signup is disabled. An administrator must create the account.",
    ...
    CHANNEL_NOT_ENTITLED: "This workspace is not entitled to that news source",
