...
function createT12DirectBlurbsRuntime({ aiTaskKernel, openaiConfig, eventStore, issueStore, analysisStore, priorityStore, reasonStore, authorizeCompany, promptRegistry, runStore, blurbStore }) {
  ...
  return { service: new DirectAlertBlurbService({ eventStore, issueStore, analysisStore, priorityStore, reasonStore, blurbStore: blurbs, promptExecutionService, authorizeCompany }), promptRegistry: registry, runStore: provenanceStore, blurbStore: blurbs };
}
