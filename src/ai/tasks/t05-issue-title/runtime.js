...
function createT05IssueTitleRuntime({ aiTaskKernel, openaiConfig, cmsSourceGate, issueStore, matchDecisionStore, relevanceDecisionStore, authorizeCompany, promptRegistry, runStore, companyStore = null, resolveOutputLanguage = null, getEffectiveContext = null }) {
  ...
  return {
    service: new IssueTitleService({
      cmsSourceGate, issueStore, matchDecisionStore, relevanceDecisionStore, promptExecutionService, companyStore, resolveOutputLanguage, getEffectiveContext, authorizeCompany,
    }),
