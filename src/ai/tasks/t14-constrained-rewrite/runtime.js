...
function createT14ConstrainedRewriteRuntime({ aiTaskKernel, openaiConfig, reportDraftStore, narrativeStore, authorizeCompany, promptRegistry, runStore }) {
  ...
  return { service: new ConstrainedRewriteService({ reportDraftStore, narrativeStore, promptExecutionService, authorizeCompany }), promptRegistry: registry, runStore: provenanceStore };
}
