...
const T02_PROMPT_VERSION = "1.12.0";
...
function createT02PromptDefinition({ modelName }) {
  return {
    ...
    inputSchemaVersion: "1.12",
    outputSchemaVersion: "2.0",
    changeSummary: "FULL CONTEXT: explicit adjacency, sub-sector, and direct-regulator materiality boundaries",
    approvedBy: null,
