...
const CLASSIFICATION_RUBRIC = {
  ...
  rules: [
    ...
    "A concrete safety, product-quality, platform-liability, climate/environment policy, education funding/access, urban-infrastructure, cost/supply, operating-disruption, or directly relevant technology/reimbursement event may be medium/high when it matches an explicit context risk, product, dependency, or priority; generic commentary, future advocacy, awards, and unconnected category adjacency remain low/none.",
