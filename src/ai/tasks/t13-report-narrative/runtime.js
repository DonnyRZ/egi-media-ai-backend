...
function createT13ReportNarrativeRuntime({ aiTaskKernel, openaiConfig, reportDraftStore, authorizeCompany, promptRegistry, runStore, narrativeStore, companyStore = null, resolveOutputLanguage = null }) {
  ...
  return {
    service: new ReportNarrativeService({
      reportDraftStore, narrativeStore: narratives, promptExecutionService, companyStore, resolveOutputLanguage, authorizeCompany,
    }),
