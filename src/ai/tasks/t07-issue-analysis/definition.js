...
const T07_PROMPT_VERSION = "1.5.0";
const T07_REVIEW_PROMPT_ID = "T07_management_perspective_review";
const T07_REVIEW_PROMPT_VERSION = "1.2.0";
...
function createT07PromptDefinition({ modelName }) {
  return {
    ...
    changeSummary: "FULL CONTEXT: leadership identity persona + explicit cited-array output shape",
    approvedBy: null, rollbackVersion: "1.4.0",
  };
}
...
function createT07ReviewPromptDefinition({ modelName }) {
  return {
    ...
    changeSummary: "Review with leadership identity stamp and explicit cited-array output shape",
    approvedBy: null,
