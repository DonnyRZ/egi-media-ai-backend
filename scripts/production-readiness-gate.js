...
const validEnv = { APP_ENV: "production", APP_HOST: "0.0.0.0", APP_PORT: "5003", CORS_ORIGINS: "https://portal.example.com", CMS_BASE_URL: "https://cms.example.com", PORTAL_BASE_URL: "https://portal.example.com", AUTH_ACCESS_TOKEN_SECRET: "x".repeat(40), OPENAI_API_KEY: "sk-test", OPENAI_MINI_MODEL: "mini", OPENAI_NANO_MODEL: "nano", SOURCE_DATABASE_URL: "postgresql://source:secret@db:5432/main", AI_DATABASE_URL: "postgresql://ai:secret@db:5432/ai", CRAWL_DATABASE_URL: "postgresql://crawl:secret@db:5432/crawl", EMAIL_TRANSPORT: "smtp", EMAIL_SMTP_HOST: "smtp.gmail.com", EMAIL_SMTP_USER: "egi.egiholding@gmail.com", EMAIL_SMTP_APP_PASSWORD: "test-app-password", EMAIL_FROM_ADDRESS: "egi.egiholding@gmail.com" };
