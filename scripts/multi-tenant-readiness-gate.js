...
for (const route of ["/api/v1/platform/tenants/{tenantId}", "/api/v1/platform/tenants/{tenantId}/companies", "/api/v1/platform/tenants/{tenantId}/companies/{companyId}", "/api/v1/platform/tenants/{tenantId}/owner", "/api/v1/tenant/companies", "/api/v1/auth/signup", "/api/v1/auth/switch-context"]) if (!swagger.paths[route]) throw new Error(`Missing Swagger route: ${route}`);
